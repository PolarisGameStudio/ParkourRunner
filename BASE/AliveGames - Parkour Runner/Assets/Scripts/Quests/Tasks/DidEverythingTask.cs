...
public class DidEverythingTask : QuestTask {
	...
	private Transform _rewardPositionTarget;
	...
	private IEnumerator CompleteProcess() {
		...
		while (qm.ActiveQuests.Count == 0 || qm.ActiveQuests.Count - 1 > qm.CompletedQuests.Count) {
