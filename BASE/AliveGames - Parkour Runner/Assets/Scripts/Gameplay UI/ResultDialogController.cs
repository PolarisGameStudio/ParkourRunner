...
public class ResultDialogController : MonoBehaviour {
	...
	[Header("Result Data Settings")] [SerializeField]
	private LocalizationComponent _distanceLocalization;
	...
	[SerializeField] private DoubleCoinsButton     _doubleCoinsButton;

	[Header("View Mode Settings")] [SerializeField]
	...
	public void Show() {
		...
		if (AdManager.Instance.RewardedVideoIsAvailable()) {
			_doubleCoinsButton.Show();
			_doubleCoinsButton.Reset();
		}
	}


	public void UpdateLabels() {
		_distanceLabel.text       = string.Format("{0}  {1} m", _distanceLocalization.Text, (int) GameManager.Instance.DistanceRun);
